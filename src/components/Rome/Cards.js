        ...
        <div className="cards__wrapper">
          <ul className="cards__items">
            <CardItem
              ...
              text={Card1}
              label="czytaj więcej..."
              path="http://our2worlds.pl/Forum/showthread.php?tid=10"
            />
            <CardItem
              src={img_2}
              text={Card2}
              label="czytaj więcej..."
              path="http://our2worlds.pl/Forum/showthread.php?tid=12"
            />
          </ul>
          <ul className="cards__items">
            <CardItem
              ...
              text={Card3}
              label="czytaj więcej..."
              path="http://our2worlds.pl/Forum/showthread.php?tid=136"
            />
            <CardItem
              src={img_4}
              text={Card4}
              label="czytaj więcej..."
              path="http://our2worlds.pl/Forum/showthread.php?tid=134"
            />
          </ul>
        </div>
      </div>
